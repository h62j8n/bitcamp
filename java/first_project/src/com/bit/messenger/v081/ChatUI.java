...
public class ChatUI extends Frame {
	...
	public Panel ChatPanel(int fW, int fH) {
		...
		btn3.setBounds(275+9, 0, commH, commH);
		...
		pList.setBounds(365+9, 0, (commH*2)+10, 200);
		listTit.setBounds(0, 10, pList.getWidth(), 20);
		chatMbList.setBounds(0, 30, (commH*2)+10, pList.getHeight()-30);
