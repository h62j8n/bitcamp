...
//		mbList = new ArrayList<Member>();
		...
		Member mbTest4 = new Member("grant", "1234", "박준서", "01011113333");
		Member mbTest5 = new Member("hyejin", "1234", "조혜진", "01012129876");
		Member mbTest6 = new Member("chohj", "1234", "조혜진", "00099991111");
		Member mbTest7 = new Member("jooj7917", "1234", "한창희", "01011112222");
