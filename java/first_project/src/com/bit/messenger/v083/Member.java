...
public class Member {
	...
	private ArrayList<ChatRoom> mbChatRooms; //멤버가 참여하고 있는 방정보
	
	public ArrayList<ChatRoom> getMbChatRooms() {
		return mbChatRooms;
	}
	public void setMbChatRooms(ArrayList<ChatRoom> mbChatRooms) {
		this.mbChatRooms = mbChatRooms;
	}
	private Socket SvrSock;   //서버쪽 알림 소켓 정보 
	private BufferedReader br; //사용자가 연결된 소켓의 최종 입력스트림 저장
	private PrintStream ps; //사용자가 연결된 소켓의 최종 출력스트림 저
	
	private Socket CliSock;   //사용자가 받은 소켓정보 
	private BufferedReader brCli; 	//클라이언트용 입력스트림
	private OutputStream osCli;  	//클라이언트용 출력스트림 
		
	public Socket getSvrSock() {
		return SvrSock;
	}
	public void setSvrSock(Socket svrSock) {
		SvrSock = svrSock;
	}
	...
	public Member(Socket sock, BufferedReader brCli, OutputStream osCli) {
		this();
		this.CliSock = sock;
		this.brCli = brCli;
		this.osCli = osCli;
	...
	public Member(){
		this.frList = new ArrayList<Member>();
		this.mbChatRooms = new ArrayList<ChatRoom>();
		this.online = false;  //사용자 온라인 off
	}
	...
	public static final String CHAT_SYNC	= "SY"; // 채팅방 내용 싱크 맞추기
	public static final String CHAT_INVITE	= "IV"; // 채팅방 초대됨
	public static final String CHAT_MEMBER 	= "CM"; // 채팅룸 참여자목록
	public static final String FR_LIST 		= "FR"; // 친구목록
	public static final String FR_UPDATE 	= "FU"; // 친구목록 업데이트
	public static final String SEARCH 		= "SR"; // 친구검색
	public static final String FR_ADD 		= "AD"; // 친구등록
	public static final String FR_REMOVE 	= "RV"; // 친구삭제
	...
	public static final String MLO00 = "로그아웃하셨습니다.";
	
	public static final String MCC01 = "채팅방이 성공적으로 만들어 졌습니다.";
	public static final String MIV01 = "채팅방이 초대되었습니다.";
	
	public static final String MSR01 = "등록된 회원이 없습니다.";
	public static final String MAD00 = "친구 등록이 완료되었습니다.";
	public static final String MAD01 = "이미 친구 등록된 회원입니다.";
	public static final String MRV00 = "선택하신 회원이 친구목록에서 삭제되었습니다.";
