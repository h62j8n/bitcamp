	...
	if(view=='search'){
		$(data).each(function(index){
			...
			var feedLi;
				...
				+'<img src="/festa/resources/upload/'+data[index].profile.prophoto+'" alt="피드 썸네일" onload="squareTrim($(this), 30)">'
		...
		$(data[0]).each(function(index){
				...
				$(data[2]).each(function(index1){
					...
					if(num==data[2][index1].mpnum){
						...
						cmmtList+='<li>'
							...
							+'<img src="/festa/resources/upload/'+data[2][index1].profile.prophoto+'" alt="'+data[2][index1].profile.proname+'님의 프로필 썸네일" onload="squareTrim($(this), 30)">'
							+'</a>'
							+'<p class="cmt_content">'
				...
				$(data[1]).each(function(index2){
					...
					if(num==data[1][index2].gpnum){
						...
						cmmtList+='<li>'
							...
							+'<img src="/festa/resources/upload/'+data[1][index2].profile.prophoto+'" alt="'+data[1][index2].profile.proname+'님의 프로필 썸네일" onload="squareTrim($(this), 30)">'
							+'</a>'
							+'<p class="cmt_content">'
			...
			+'<span class="pf_picture"><img src="/festa/resources/upload/'+data[0][index].profile.prophoto+'" alt="'+data[0][index].profile.proname+'님의 프로필 썸네일" onload="squareTrim($(this), 55)"></span>'
			...
			$(data[1]).each(function(index1){
				...
				if(data[0][index].gpnum==data[1][index1].gpnum){
					...
					cmmtList+='<li>'
						...
						+'<img src="/festa/resources/upload/'+data[1][index1].profile.prophoto+'" alt="'+data[1][index1].profile.proname+'님의 프로필 썸네일" onload="squareTrim($(this), 30)">'
						+'</a>'
						+'<p class="cmt_content">'
		...
		$(data[0]).each(function(index){
			...
			+'<img src="/festa/resources/upload/'+data[0][index].profile.prophoto+'" alt="'+data[0][index].profile.proname+'님의 프로필 썸네일" onload="squareTrim($(this), 55)">'
			+'</span>'
