							...
							<c:when test="${paging.totalCount ne 0 }">
								<c:forEach items="${venture }" var="venture">
									<tr>
										...
										<td>${venture.mvrn }</td>
										<td><button type="button" class="btn_pop" data-layer="ventureImage">${venture.mvnumber }</button></td>
										<td>
											<p>
	...
	<div class="del_wrap pop_wrap">
		...
		<form>
			<ul class="comm_buttons">
				...
				<li><button type="button" class="btn_pop comm_btn cfm venture_delete" data-layer="success">삭제하기</button></li>
			</ul>
		</form>
	</div>
