				...
				<div class="feed_viewer">
					<div class="tit box">
						...
						<ul class="feed_options">
							...
							<li><a href="${root}hot/report" class="btn_pop btn_report"><em class="snd_only">신고하기</em></a></li>
							<li><a href="${root}hot/maker" class="btn_pop btn_edit"><em class="snd_only">수정하기</em></a></li>
